...
public class WebApplicationClientApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		OAuth2AuthorizeRequest authorizeRequest = OAuth2AuthorizeRequest.withClientRegistrationId("client1").principal("client1-service").build(); // Build an OAuth2 request for the Okta provider
